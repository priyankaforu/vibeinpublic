...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-cream pt-40 pb-16 px-6 md:px-12 lg:px-24 border-t-2 border-black relative overflow-hidden">
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <a href="https://x.com/i/communities/1992867116429771142" target="_blank" rel="noopener noreferrer" className="inline-block bg-sage hover:bg-sage-dark text-white font-sans font-bold px-12 py-5 rounded-xl text-xl transition-all shadow-hard active:translate-x-1 active:translate-y-1 active:shadow-none border-2 border-black">
          Join Squad
        </a>
        ...
        <div className="mt-32 flex flex-col md:flex-row justify-between items-center text-sm font-sans font-medium text-gray-500 border-t-2 border-gray-200 pt-8">
          ...
          <div className="flex gap-8 mt-4 md:mt-0">
             <a href="https://x.com/i/communities/1992867116429771142" target="_blank" rel="noopener noreferrer" className="hover:text-dark underline decoration-2 decoration-transparent hover:decoration-sage transition-all">Twitter/X</a>
             <a href="https://www.instagram.com/vibe.inpublic/" target="_blank" rel="noopener noreferrer" className="hover:text-dark underline decoration-2 decoration-transparent hover:decoration-sage transition-all">Instagram</a>
